...
The majority of the 3000 benchmark runs mentioned in chapters
...
resulting in the formula $5.885J * 10^{-9} *$ \JWctr{CPU\_CLK\_UNHALTED}.
...
CPU cycles or the time a process needs to complete. The
Pearson product-moment correlation coefficients\cite{wiki:PCC} are $-0.18$ with
respect to the running time and $-0.12$ to the clock cycles. Considering the
